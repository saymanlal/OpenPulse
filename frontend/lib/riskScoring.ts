...
import { GraphAnalytics, CentralityScores, DependencyMetrics } from './graphAnalytics';
...
export class RiskScoringEngine {
  ...
  constructor(nodes: GraphNode[], edges: GraphEdge[], config: RiskConfig = DEFAULT_CONFIG) {
    this.nodes = nodes;
    this.edges = edges;
    this.config = config;
